...
<section class="hero blog" style="background: linear-gradient(180deg, #192a388c, #192a388c), url('<?php echo get_template_directory_uri(); ?>/assets/img/banner.png') no-repeat top center; background-size: cover;">
