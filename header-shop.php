...
<div id="page" class="site">
	...
	<header id="header" class="header js-entryAnimation js-header whiteBg">
		...
		<div class="header__container container">
							...
							if( $link ): 
								...
								<a class="button" href="<?php echo esc_url( $link_url ); ?>" target="<?php echo esc_attr( $link_target ); ?>">
									...
									if ( is_user_logged_in() ) {
										...
										echo get_field('title_sing_up_link', 'options');
									}
									?>
								</a>
							<?php endif; ?>
			...
			<div class="header__signHamburguer">
				<div class="header__signIn">
					...
					<a class="header__bag--white" href="<?php echo get_the_permalink( $cart_page_id )?><?php echo get_the_permalink( $cart_page_id )?>">
