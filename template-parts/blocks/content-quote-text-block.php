...
<?php else : ?>
    ...
    <?php $mobileBottom = ''; ?>
<?php endif; ?>
<section class="quoteBlock custom-paddings" style="
...
--data-pb-mobile: <?php echo $mobileBottom; ?>px;">
    ...
    <div class="container mediumContainer">
        <div class="quoteBlock__text">
            <?php if ( get_field('title_quote') ) : ?>
                <h2 class="heading big"><?php echo get_field('title_quote'); ?></h2>
            <?php endif; ?>
            <?php if ( get_field('small_text_quote') ) : ?>
                <p class="heading uppercase"><?php echo get_field('small_text_quote'); ?></p>
            <?php endif; ?>
        </div>
    </div>
