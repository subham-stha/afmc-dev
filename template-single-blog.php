...
<i class="bi bi-chevron-left"></i>Back
   ...
   <div class="row">
  <div class="col-4">
    <div id="simple-list-example" class="d-flex flex-column gap-2 simple-list-example-scrollspy text-left sticky-top">
      <a class="p-1 rounded" href="#simple-list-item-1">What Are Forensic Medical Coders?</a>
      <a class="p-1 rounded" href="#simple-list-item-2">A Unique Skillset</a>
      <a class="p-1 rounded" href="#simple-list-item-3">The Reole of Forensic Medical Coders</a>
      <a class="p-1 rounded" href="#simple-list-item-4">The Importance of Accuracy</a>
      <a class="p-1 rounded" href="#simple-list-item-5">A Growing field</a>
      <a class="p-1 rounded" href="#simple-list-item-5">Conclusion</a>
    </div>
  </div>
  <div class="col-8">
	...
	<p>In the bustling world of healthcare, there's an often-overlooked group of professionals whose work plays a critical role in understanding and analyzing complex medical events: forensic medical coders. While most people are familiar with medical coders in a clinical setting, forensic medical coders operate in a different arena, often working with law enforcement, insurance companies, and legal teams. Let's dive into their world to understand what they do and why their work is so important.</p>
      <h4 id="simple-list-item-1">What Are Forensic Medical Coders?</h4>
      ...
      <h4 id="simple-list-item-2">A Unique Skillset</h4>
      ...
      <h4 id="simple-list-item-3">The Reole of Forensic Medical Coders</h4>
      ...
      <h4 id="simple-list-item-4">The Importance of Accuracy</h4>
      ...
      <h4 id="simple-list-item-5">A Growing field</h4>
      ...
      <h4 id="simple-list-item-5">Conclusion</h4>
